...
function user_setup()
    ...
    state.IdleMode:options('Refresh', 'PDT', 'Melee')
...
function init_gear_sets()
    ...
    sets.precast.JA['Life Cycle'] = {head="Azimuth Hood +3", body="Geomancy Tunic +1", back="Nantosuelta's Cape"}
    ...
    sets.precast.FC = {
        ...
        ring2="Kishar Ring",
	back={ name="Nantosuelta's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Evasion+9','"Fast Cast"+10',}},
    }    
    ...
    sets.idle.PDT = set_combine(sets.idle.Refresh, {
        hands="Azimuth Gloves +2",
        feet="Azimuth Gaiters +3"
    ...
    sets.latent_refresh = {body="Azimuth Coat +2", waist="Fucho-no-obi"}
