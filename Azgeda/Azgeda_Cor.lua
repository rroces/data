...
function user_setup()
    ...
    state.Gun = M{['description']='Gun', 'DeathPenalty', 'Fomalhaut', 'Ataktos'}
    state.WeaponSet = M{['description']='Melee', 'Dagger', 'Sword', 'DaggerRanged'}
...
function init_gear_sets()
    ...
    sets.Dagger = {main={name="Rostam",bag="wardrobe"}, sub="Gleti's Knife"}
    sets.DaggerRanged = {main={name="Rostam",bag="wardrobe 2"}, sub="Nusku Shield"}
...
function set_lockstyle()
    send_command('@wait 8;input /lockstyleset 4')
end
