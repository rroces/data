...
state.WeaponMode:options('Fomalhaut','Death Penalty','Armageddon','Earp', 'Savage Blade', 'Aeolian Edge', 'Evisceration')
...
function get_sets()
	...
	sets.Weapons['Aeolian Edge'] = {
		...
		main={ name="Rostam", augments={'Path: A'}, bag="Wardrobe 8"},
		sub="Tauret",
		range={ name="Ataktos", augments={'Delay:+60','TP Bonus +1000',}},
	}
	...
	sets.JA["Triple Shot"] = {body="Chasseur's Frac +3"}	-- Gear to be worn during Midshot
	...
	sets.PhantomRoll = {
		main={ name="Rostam", augments={'Path: C'}, bag="Wardrobe 4", priority=1}, -- +8 Effect and 60 sec Duration
