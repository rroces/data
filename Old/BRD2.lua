...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc','NIN','DNC','REGAL','Rebbl','test')
...
function init_gear_sets()
    ...
    sets.precast.FC = {
		...
		sub="Genmei Shield",
		head= "C. PAlug Crown", --Nahtirah Hat",
		...
		right_ring= "prolix ring", --"Rahab Ring",
    ...
    sets.precast.WS['Aeolian Edge'] = {
		...
		waist="skrymir cord +1", --Orpheus's Sash",
	...
	--sets.midcast['Knight\'s Minne V'] = {legs="Mousai Seraweels +1"}
	--sets.midcast = {legs="Mou. Seraweels +1"}
    sets.midcast.Minuet = {body="Fili Hongreline +3"}
    sets.midcast.Paeon = {head="Brioso Roundlet +3"}
	--sets.midcast["Dark Threnody"]  = {
	sets.midcast.Threnody = {
			main="Carnwenhan",
			sub="Ammurapi Shield",
			--range= "Pemphredo Tathlum", --8  > BIS { name="Linos", augments={'Mag. Acc.+20','"Fast Cast"+6','INT+8',}},
			body="Mou. Manteel +1",
		head="Fili Calot +3", -- 61
		neck="Mnbw. Whistle +1", --23
			hands="Fili Manchettes +3", --63
		left_ear="Crep. Earring", --10
        right_ear="Fili Earring +1",-- 14
			feet="Fili Cothurnes +3",  --60
			legs="Volte Brais", --48
			ring1="Stikini Ring +1", --11
			ring2="Stikini Ring +1", --11
			waist="Acuity Belt +1", -- 15
			back={ name="Intarabus's Cape", augments={'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Damage taken-5%',}},     
    ...
    sets.midcast.SongEnhancing = {
        ...
        legs= "Inyanga Shalwar +2",--"brioso cannions +2",
						    ...
						    sets.midcast.Lullaby.Enmity =
	{
        ...
        neck={ name="Unmoving Collar +1"},
        waist="Warwolf Belt",
        left_ear= "friomisi Earring", --"Trux Earring", --cryptic
        right_ear="Cryptic Earring", 
        left_ring= "provocare ring", --"Begrudging Ring", --provocare
        right_ring= "eihwaz ring", --"Supershear Ring", --eihwaz
        back="Reiki Cloak",}
	...
	sets.midcast.AbsorbTP = {
		...
		--range={ name="Linos", augments={'Mag. Acc.+20','"Fast Cast"+6','INT+8',}}, --Maximum linos FC         
		--range={ name="Linos", augments={'Mag. Acc.+15','"Fast Cast"+5','INT+8',}},         
		head={ name="Bunzi's Hat", augments={'Path: A',}},         
		hands={ name="Leyline Gloves", augments={'Accuracy+9','Mag. Acc.+5','"Mag.Atk.Bns."+6','"Fast Cast"+1',}},         
		legs="Aya. Cosciales +2",         
		feet="Fili Cothurnes +3",  
		body= "Zendik Robe", --"Inyanga Jubbah +2",
		neck="Voltsurge Torque",        
		waist="Witful Belt",         
		left_ear="Enchntr. Earring +1",        
		right_ear="Fili Earring +1",         
...
-- }
	...
	---- sets["Brd absorb-TP"] 
		...
		-- body="Zendik Robe", --45
		-- hands="Fili Manchettes +3" --63
		--ear1="Crepuscolar Earring", --10
		--ear2="Fili Earring +1",-- 14
		--feet="Fili Cothurnes +3"  --60
		--legs="Volte Brais", --48
		--ring1="Stikini Ring +1", --11
		--ring2="Stikini Ring +1", --11
		...
		-- range= "Pemphredo Tathlum", --{ name="Linos", augments={'Mag. Acc.+20','"Fast Cast"+6','INT+8',}}, 
		-- --range={ name="Linos", augments={'Mag. Acc.+15','"Fast Cast"+5','INT+8',}},        
		-- head={ name="Bunzi's Hat", augments={'Path: A',}},        
		-- body="Inyanga Jubbah +2",        
		-- hands= "Leyline Gloves", --augments={'Accuracy+15','Mag. Acc.+15','"Mag.Atk.Bns."+15','"Fast Cast"+3',}},      
		...
		-- neck="Voltsurge Torque",        
		-- waist="Witful Belt",      
		-- left_ear= "crepuscular Earring", --"Enchntr. Earring +1",        
		-- right_ear="Fili Earring +1",         
		...
		-- sets.midcast.AbsorbTP = {     --range={ name="Linos", augments={'Mag. Acc.+20','"Fast Cast"+6','INT+8',}}, 
-- --Maximum linos FC        
 -- range={ name="Linos", augments={'Mag. Acc.+15','"Fast Cast"+5','INT+8',}},      .
   -- head={ name="Bunzi's Hat", augments={'Path: A',}},     
   -- body="Inyanga Jubbah +2",    
 ...
 -- sets.engaged = {
  ...
  sets.engaged.DW.REGAL = {
    ...
    sets.engaged.Aftermath = sets.engaged.DW 
	    ...
	    sets.engaged.DW.Rebbl = {
		--range={ name="Linos", augments={'Accuracy+20','"Store TP"+4','Quadruple Attack +3',}},
		ammo = "Aurgelmir Orb",
		head= "blistering sallet +1", --"Bunzi's hat", --"Aya. Zucchetto +2",
		body="Volte Harness", --"Ayanmo Corazza +2",--"Ashera Harness",
		hands="volte mittens",
		legs="Volte tights",
		feet= "Volte Spats",--"battlecast gaiters",
		neck= "Bard's Charm +2", --{ name="Bard's Charm +2", augments={'Path: A',}},
		waist="reiki yotai", --"sailfi Belt +1",
		left_ear="Telos Earring",
		right_ear="Dignitary's Earring",
		left_ring= "hetairoi ring",      --{name="Chirich Ring +1", bag="wardrobe3"},
		right_ring= "Ilabrat ring",     --{name="Chirich Ring +1", bag="wardrobe4"},
